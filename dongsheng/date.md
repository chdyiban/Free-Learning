...
1.18|看了asyncio的文档，后面的草草看完了，另外看了一下treq已经aiohttp的文档，感觉很怀念requests，尝试用asyncio构建一套类似requests的api的协程爬虫模块，暂时不知道是否可行。后期如果完成，将用这个对阻塞代码进行优化，如果做不出来，那就使用treq或者aiohttp进行
