...
10.14|改了改之前爬虫的bug，一个由于title没有做转义导致的错误和一个由于author太长导致的错误以及在信息门户的新闻有部分会跳转到其他链接，这个直接在框架里面设置为禁止访问了。另外有一个bug，似乎每次爬虫爬取文章数量总是预计的两倍，这个有待解决。</br>2、继续看scrapy的文档和《learning scrapy》，学习使用Item Loader来处理响应，有助于简化代码
